...
// Segment selectors
#define SEGSEL_KERN_DATA        0x8             // kernel data segment
#define SEGSEL_KERN_CODE        0x10            // kernel code segment
#define SEGSEL_APP_DATA         0x18            // application data segment
#define SEGSEL_APP_CODE         0x20            // application code segment
